...
// Har menu item ka apna distinct accent color — inactive state me icon isi rang ka hoga
const ITEM_COLORS = {
...
function Sidebar({ open, onClose }) {
  ...
  bg-gradient-to-b from-black via-[#0a0a0f] to-black border-r border-white/[0.06]
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `group flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 relative ${
                    isActive
                      ? "bg-gradient-to-r from-primary/25 to-primary/5 text-white ring-1 ring-primary/30 shadow-[0_0_20px_-6px_rgba(37,99,235,0.5)]"
                      : "text-dark-muted hover:bg-white/[0.04] hover:text-white"
                  }`
                }
              >
                {({ isActive }) => (
